						...
						<tbody>
							<?php 
								...
								<tr>
									...
									<td><?= $count['nbEtab']; ?></td>
									<td>
										<a href="details.php?idEtablissement_Etablissement=<?= $count['idEtablissement_Etablissement'] ?>"><i class="bi bi-eye"> Plus de détails</i></a> <br>
										<a href=""><i class="bi bi-pencil-square"> Modifier</i></a> <br>
