...
<table class="table table-hover">
  ...
  <th scope="row"><a href='.$url_formation.'>'.$id_Formation.'</th>
  <td><a href='.$url_formation.'>'.$nm_Etablissement.'</td>
  <td><a href='.$url_formation.'>'.$nm_formation.'</td>
  <td><a href='.$url_formation.'>'.$nm_Etablissement.'</td>
  <td><a href='.$url_formation.'>'.$ville_formation.'</td>
  <td><a href="tel:'.$tel_Etablissement.'">'.$tel_Etablissement.'</td>
</tr></a>';
}
